...
public class Cryptopangrams {
    ...
    public Set<Integer> getFactor(int n, List<Integer> primes) {
    ...
    public String calculate(int size, List<Integer> cipherText) {
    ...
    public String solve(int size, List<Integer> cipherText) {
